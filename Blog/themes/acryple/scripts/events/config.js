...
hexo.extend.filter.register('before_generate', () => {
  ...
  const internalSrcCDN = {
    ...
    main: `https://cdn.jsdelivr.net/npm/hexo-theme-butterfly@${version}/source/js/main.js`,
    utils: `https://cdn.jsdelivr.net/npm/hexo-theme-butterfly@${version}/source/js/utils.js`,
    translate: `https://cdn.jsdelivr.net/npm/hexo-theme-butterfly@${version}/source/js/tw_cn.js`,
    local_search: `https://cdn.jsdelivr.net/npm/hexo-theme-butterfly@${version}/source/js/search/local-search.js`,
    algolia_js: `https://cdn.jsdelivr.net/npm/hexo-theme-butterfly@${version}/source/js/search/algolia.js`,
  }
  ...
  const thirdPartySrcCDN = {
    ...
    gitalk: 'https://cdn.jsdelivr.net/npm/gitalk/dist/gitalk.js',
    gitalk_css: 'https://cdn.jsdelivr.net/npm/gitalk/dist/gitalk.css',
    ...
    sharejs: 'https://cdn.jsdelivr.net/npm/dist/js/social-share.min.js',
    sharejs_css: 'https://cdn.jsdelivr.net/npm/social-share.js/dist/css/share.min.css',
    mathjax: 'https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-mml-chtml.js',
    katex: 'https://cdn.jsdelivr.net/npm/katex/dist/katex.min.css',
    katex_copytex: 'https://cdn.jsdelivr.net/npm/katex/dist/contrib/copy-tex.min.js',
    ...
    instantpage: 'https://cdn.jsdelivr.net/npm/instant.page@5/instantpage.js',
    typed: 'https://cdn.jsdelivr.net/npm/typed.js/dist/typed.umd.js',
    pangu: 'https://cdn.jsdelivr.net/npm/pangu@4/dist/browser/pangu.min.js',
    fancybox_css_v4: 'https://cdn.jsdelivr.net/npm/@fancyapps/ui/dist/fancybox/fancybox.css',
    fancybox_v4: 'https://cdn.jsdelivr.net/npm/@fancyapps/ui/dist/fancybox/fancybox.umd.js',
    ...
    flickr_justified_gallery_css: 'https://cdn.jsdelivr.net/npm/flickr-justified-gallery@2/dist/fjGallery.css',
    ...
    meting_js: 'https://cdn.jsdelivr.net/npm/meting/dist/Meting.min.js',
    prismjs_js: 'https://cdn.jsdelivr.net/npm/prismjs@1/prism.js',
